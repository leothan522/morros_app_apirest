...
<head>
    ...
    <style em="styles">
        ...
        .em-font-Inter-Regular,.em-font-Inter-SemiBold {
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size: 1px; line-height: normal;">
    <tr em="group">
        <td align="center" bgcolor="#FBF7EE" style="background-color: #fbf7ee; padding: 20px 40px;" class="em-mob-padding_top-10 em-mob-padding_right-20 em-mob-padding_bottom-10 em-mob-padding_left-20">
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="max-width: 640px; min-width: 640px; width: 640px;" class="em-narrow-table">
                            ...
                            <tr>
                                <td width="560" valign="top" class="em-mob-wrap em-mob-width-100perc">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                                        <tr>
                                            <td align="center">
                                                <img src="<?= $logo ?>" width="80" border="0" alt="" style="display: inline-block; width: 80%; max-width: 150px;">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr em="block" class="em-structure">
                    <td align="center" style="padding: 30px 40px; background-color: #ffffff; background-repeat: repeat; border-radius: 20px;" class="em-mob-padding_top-20 em-mob-padding_right-20 em-mob-padding_bottom-20 em-mob-padding_left-20" bgcolor="#fff">
                        <table border="0" cellspacing="0" cellpadding="0" class="em-mob-width-100perc">
                            <tr>
                                <td width="560" class="em-mob-wrap em-mob-width-100perc" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                                        <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                                        <tr>
                                            <td align="center">
                                                <img src="https://cdn.useblocks.io/19015/240119_1467_r1TYJ6Z.png" width="340" border="0" alt="" style="display: block; width: 100%; max-width: 340px;">
                                            </td>
                                        </tr>
                                    </table>
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                ...
                <tr em="block" class="em-structure">
                    <td align="center" style="padding: 30px 40px 20px;" class="em-mob-padding_left-20 em-mob-padding_right-20">
                        <table border="0" cellspacing="0" cellpadding="0" class="em-mob-width-100perc">
                            <tr>
                                <td width="560" valign="top" class="em-mob-wrap em-mob-width-100perc" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                                        <tr>
                                            <td style="padding-right: 0px; padding-bottom: 16px; padding-left: 0px;">
                                                <div class="em-font-Mulish-Bold" style="font-family: -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #1f1f1f;" align="center"><strong><?= $name ?></strong></div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" em="atom">
                                        <tr>
                                            <td align="center">
                                                <div class="em-font-Mulish-Regular" style="font-family: -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 12px; line-height: 18px; color: #595959;" align="center">
                                                    <?= $footer ?>
                                                    <br>
                                                </div>
                                            </td>
