...
<head>
    ...
    <title><?= env('app_name', 'Wellcome') ?></title>
    ...
    <link rel="stylesheet" href="<?php asset('build/assets/app-CJSwBMaS.css'); ?>">
...
<script src="<?php asset('build/assets/app-BQ20r_nR.js'); ?>"></script>
